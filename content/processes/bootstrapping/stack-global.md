...
* `Config variables` can be configured by creating a `global.sh` file in the root folder and export the stack specific variables from there. It will reduce the chances of errors in configuration because now few CI/CD variables needs to be changed for deployment. Example of config file is given below:
```bash
export BRANCH="master"
export INSTALL_PVC="true"
export NAMESPACE="global"
export PROVIDER="aws"
export REPO_URL="github.com/stakater/StakaterKubeHelmGlobal.git"
